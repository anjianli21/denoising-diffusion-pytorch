...
python /home/al5844/desktop/project/denoising-diffusion-pytorch/run/train_classifier_free_cond_1d.py --machine della --data_path /scratch/gpfs/al5844/project/denoising-diffusion-pytorch/Data/cr3bp_alpha_time_mass_control.pkl --class_dim 5 --channel_num 3 --seq_length 20 --wandb_project_name diffusion_for_cr3bp_$training_data_type --training_data_type $training_data_type --training_data_num 30000

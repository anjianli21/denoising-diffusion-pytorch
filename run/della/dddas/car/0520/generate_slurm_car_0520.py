...
# constraint_loss_types = ['predict_x0_violation', 'predict_x0_violation', 'predict_x0_violation', 'predict_x0_violation', 'gt_scaled', 'gt_scaled', 'gt_scaled', 'gt_scaled']
# constraint_violation_weights = ['0.1', '0.1', '0.01', '0.01', '0.1', '0.1', '1', '1']
# constraint_loss_schedulings = ["one_over_t", "one_over_t", 'NA', "NA", "NA", 'NA', "NA", "NA"]
# max_sample_steps = ['500', '500', '100', '100', '500', '500','100', '100']
# normalize_xt_types = ['direct_clip', 'direct_clip', 'direct_clip', 'direct_clip', 'direct_clip', 'direct_clip', 'direct_clip', 'direct_clip']
# randome_seeds = ['1', '2', '1', '2', '1', '2', '1', '2']

constraint_loss_types = ['predict_x0_violation', 'predict_x0_violation']
constraint_violation_weights = ['0.001', '0.001']

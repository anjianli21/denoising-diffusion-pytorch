...
"""
    ...
    for i in range(num_files):
        ...
        training_data_type = f"car_constraint_{constraint_loss_types[i]}_schedule_{constraint_loss_schedulings[i]}_normalize_{normalize_xt_types[i]}_max_sample_{max_sample_steps[i]}_weight_{weight_without_dot}_seed_0"

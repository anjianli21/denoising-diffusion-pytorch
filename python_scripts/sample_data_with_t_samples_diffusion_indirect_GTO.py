...
def main(unet_dim,embed_class_layers_dims,timesteps,data_num,sample_num,thrust,diffusion_w,batch_size):
    ...
    checkpoint_path = f"/scratch/gpfs/jg3607/Diffusion_model/indirect_GTO/results/cr3bp_vanilla_diffusion_seed_0/unet_{unet_dim}_mults_{unet_dim_mults_in_str}_embed_class_{embed_class_layers_dims_in_str}_timesteps_{timesteps}_batch_size_{batch_size}_cond_drop_0.1_mask_val_-1.0_train_data_{data_num}/"

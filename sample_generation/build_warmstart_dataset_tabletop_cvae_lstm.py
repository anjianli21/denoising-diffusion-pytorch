...
CVAE_PARENT_DIR = "results/from_autodl/cvae_lstm/tabletop/cvae_seed_1"
RNN_PARENT_DIR = "results/from_autodl/cvae_lstm/tabletop/lstm_seed_1"

def main():


    data_type_list = ["cvae_lstm_seed_1"]
